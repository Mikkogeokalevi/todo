...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const speedDisplay = document.getElementById('speed-display'); // UUSI
    ...
    let wakeLock = null; // UUSI: Wake Lock -oliolle
    ...
    const showNotification = (message, type = 'info') => {
        ...
        setTimeout(() => { notification.remove(); }, 8000); // Pidennetty 8 sekuntiin
    };
    ...
    const toggleTracking = async () => {
        ...
        if (trackingWatcher) {
            ...
            await requestWakeLock(); // Pyydä näyttölukkoa
